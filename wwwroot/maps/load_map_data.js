...
function SetAdminData(dataAdminLevel, dataAdminInfo, dataViewLevel) {
    ...
    baseUrl = baseUrl ? baseUrl : "../SurveyInfoes/Index",
        ...
        table = $("<table>").addClass("table data-table noselect"),
        summarize_data = {};
        ...
        $.ajax({
            ...
            complete: function () {
                if (summarize_data) {
                    ...
                    var table1 = $("<table>").addClass("table data-table noselect");
                    ...
                    if (allLocations && allLocations.length > 0) {
                        ...
                        var getLatLng = function (lat, lng) {
                            ...
                            getInfo = function (el) {
                                ...
                                return "<div style='display: inline-block; overflow: auto; width:485px; max-width: 754px; max-height: 654px;'>" +
